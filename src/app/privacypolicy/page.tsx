  ...
  sections: [
    {
      ...
      content: {
        type: 'ordered',
        items: [
          'Polityka prywatności określa, jak zbierane, przetwarzane i przechowywane są dane osobowe Użytkowników niezbędne do świadczenia usług drogą elektroniczną za pośrednictwem serwisu internetowego https://www.adwokatagnieszkajasak.pl (dalej: Serwis).',
